...
test("verifySignature accepts a matching sha256 header", async () => {
...
test("verifySignature rejects a wrong digest, a missing prefix, and a missing header", async () => {
...
test("verifySignature rejects a digest of a different body", async () => {
