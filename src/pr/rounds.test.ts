...
test("reviewRounds clusters comments by original_commit_id in time order", () => {
...
test("incrementalBase is the previous clustered commit, not the current head", () => {
...
test("matchRepeat pairs a finding to the earlier thread on the same lines", () => {
