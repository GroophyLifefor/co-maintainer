...
test("patchFromNewFileContent: empty file", () => {
...
test("patchFromNewFileContent: two lines with trailing newline", () => {
...
test("patchFromNewFileContent: no trailing newline", () => {
...
test("patchFromNewFileContent: NUL in first bytes is binary", () => {
