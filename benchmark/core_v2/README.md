...
**root** that holds one clone per repo (`benchmark/core_v2/clones/owner+repo` — `+`
...
```sh
git clone https://github.com/owner/repo benchmark/core_v2/clones/owner+repo
git -C benchmark/core_v2/clones/owner+repo fetch origin <round_base_commit> <round_commit>
```
